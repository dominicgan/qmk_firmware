...
// #endif
    ...
    LAYOUT_all(
        ...
        KC_RSFT,    KC_LSFT, KC_Z,   KC_X,   KC_C,    KC_V,   KC_B,    KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,    KC_SLSH, KC_UP,   KC_DEL,  \
        F(0), KC_LALT, KC_LGUI,                         KC_SPC,                               KC_RGUI, KC_LEFT,  KC_LEFT, KC_DOWN, KC_RGHT),
    // 1: Function layer
    LAYOUT_all(
        ...
        KC_NO,    KC_NO,    KC_APP,  RGB_TOG, RGB_MOD, RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, KC_SLSH,    KC_RSFT,   KC_PGUP, KC_GRV,\
        F(0),     KC_NO,    KC_NO,                           KC_NO,                           KC_NO,   KC_HOME,    KC_HOME, KC_PGDN, KC_END),
};
